...
[Description("Represents a Power BI import object that contains information about imported items like reports and datasets.")]
public class ImportDataObject
{
    ...
    // Nested classes for datasets and reports
